...
Scoring Criteria:
    Completeness (0-5 points) – Does the response fully address the topic?
    Accuracy (0-5 points) – Are the facts correct?
    Depth & Context (0-5 points) – Does it provide explanations, examples, and relevant insights?
    Clarity & Readability (0-5 point) – Is it well-structured and easy to understand?
    Usefulness & Application (0-5 point) – Can the response be practically applied?
